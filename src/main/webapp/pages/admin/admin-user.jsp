...
<body class="bg-light">
	...
	<div class="container py-4">
		...
		<!-- DANH SÁCH USERS -->
		<div class="card mb-4">
			<div class="card-header bg-dark text-white">Danh sách người
				dùng</div>
			<div class="card-body">
							...
							<tr>
								...
								<td><a class="btn btn-sm btn-primary"
									...
									<button class="btn btn-sm btn-danger" data-bs-toggle="modal"
										data-bs-target="#deleteModal${u.id}">Xóa</button>
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													Bạn có chắc muốn xóa người dùng: <strong>${u.fullName}</strong>
													(${u.email})?
												</div>
		...
		<div class="card">
			...
			<div class="card-body">
				<form method="post"
					...
					<div class="mb-3">
						<label class="form-label"> Mật khẩu <c:if
								test="${user != null}">
					...
					<div class="form-check mb-3">
						...
						<label class="form-check-label" for="activeCheck"> Hoạt
							động </label>
					</div>
